...
<p>I learned a lot from this project — especially TypeScript, Tailwind CSS, and Next.js. I also improved my communication skills working with teammates, and learned a great deal from my seniors.</p>`,
	...
	},
	{
		...
		description: `<p>A micro-frontend dashboard built for managing truck logistics at the port. Covers the full end-to-end workflow — from booking and scheduling to operational tracking.</p>
<p>This project challenged me to deliver a responsive, real-time dashboard with complex state management across multiple micro-frontend modules, integrating with existing port operation systems.</p>`,
		year: '2023',
		role: 'Fullstack Developer',
		type: 'Group · PT. ILCS',
